...
def open_nw_8():
    ...
    Button(top5,text='Male',command=voiceChange_male,font=('Times',20)).place(relx=0.5,rely=0.5,anchor='center')
    Button(top5, text='Female', command=voiceChange_female,font=('Times',20)).place(relx=0.5,rely=0.6,anchor='center')
def prog():
    global s
    import random
    bl = ['book_1', 'book_2', 'book_3', 'book_4']
    el = ['education_1', 'education_2', 'education_3', 'education_4']
    ml=['movie_1','movie_2','movie_3','movie_4','movie_5']
    gl = ['general_1', 'general_2', 'general_3', 'general_4']
    sl = ['song_1.txt', 'song_2.txt', 'song_3.txt', 'song_4.txt']
    spl = ['sports_1', 'sports_2', 'news_1', 'news_2']
    while True:
        if ch == '1':
            a = random.choice(bl)
            break
    ...
    c_restaurant_name = fun2('restaurant_name_', c_restaurant_name)
    ...
    while True:
        if a=='':
            ...
            Button(top4,text='Click here',command=open_nw_8,font=('Times',20)).place(relx=0.5,rely=0.9,anchor='center')
            break
        else:
            print('Invalid input')
def open_nw_2():
    ...
    Button(top2,text='Click me!',command=prog, font=('Times',25)).place(relx=0.5,rely=0.5,anchor='center')  
    ch='1'
def open_nw_3():
    global ch
    top2=Toplevel(root)
...
def open_nw_1():
    ...
    b1=Button(top1,text=s2,command=open_nw_2,font=('Times',25))
    b1.place(relx=0.2,rely=0.3,anchor='center')
    b2=Button(top1, text=s3, command=open_nw_3,font=('Times',25))
    b2.place(relx=0.2, rely=0.8, anchor='center')
    b3=Button(top1, text=s4, command=open_nw_4,font=('Times',25))
    b3.place(relx=0.5, rely=0.3, anchor='center')
    b4=Button(top1, text=s5, command=open_nw_5,font=('Times',25))
    b4.place(relx=0.5, rely=0.8, anchor='center')
    b5=Button(top1, text=s6, command=open_nw_6,font=('Times',25))
    b5.place(relx=0.8, rely=0.3, anchor='center')
    b5 = Button(top1, text=s7, command=open_nw_7,font=('Times',25))
    b5.place(relx=0.8, rely=0.8, anchor='center')
button1=Button(root,text='Start',command=open_nw_1,font=('Times',30))
